...
class PostController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        #Get all the category IDs of this post.
        $selected_categories = [];
    ...
    public function update(Request $request, $id)
    {
        ...
        //Equivalent :DELETE FROM category_post table
     ...
     #1. create the destroy function
     #2. Add a route insode web.php
     #3. User the route inside the delete modals folder.
