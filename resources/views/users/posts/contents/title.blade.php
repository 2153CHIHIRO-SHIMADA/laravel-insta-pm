    ...
    <div class="row align-item-center">
        <div class="col-auto">
            <a href="{{route('profile.show', $post->user->id)}}">
                @if($post->user->avatar)
                <img src="{{$post->user->avatar}}" alt="{{$post->user->name}}" class="round-circle avatar-sm">
                @else
        ...
        <div class="col-auto">
            <div class="dropdown">
               <button class="btn btn-sm shadow-none" data-bs-toggle="dropdown">
                ...
                {{--If you are the owner of the post, you edit or delete this post--}}
                ...
                @else
                    ...
                    <div class="dropdown-menu">
                    <from action="{{route('follow.destroy',$post->user->id)}}" method="post">
                        @csrf
                        @method('DELETE')
