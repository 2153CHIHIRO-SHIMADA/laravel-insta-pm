    ...
    <div class="col-8">
        <form action="{{route('profile.update')}}" method="post" class="bg-white shadow rounded-3 p-5" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-4">
                    @if($user->avatar)
                    <img src="{{$user->avatar}}" alt="{{$user->name}}" class="rounded-cricle d-block mx-auto avatar-lg">
           ...
           <div class="mb-3">
            ...
            <div class="mb-3">
                 ...
                 <textarea name="introduction" id="introduction" row="5" class="form-control" placeholder="Describe yourself">{{old('introduction', $user->introduction)}}</textarea>
